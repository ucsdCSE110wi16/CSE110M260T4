...
@LargeTest
public class SearchByIngredientsScenario {

    public static final String STRING_TO_BE_TYPED = "tomatoes";
    public static final String STRING_TO_BE_TYPED2 = "toast";
    public static final String RECIPE_TITLE = "chili";
